...
namespace BlackFoxCSharp.Model
{
    ...
    public partial class AnnOptimizationStatus : IEquatable<AnnOptimizationStatus>
    {
        ...
        public AnnModel BestModel { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AnnOptimizationStatus {\n");
        ...
        {
            return this.Equals(input as AnnOptimizationStatus);
        }

        /// <summary>
        /// Returns true if AnnOptimizationStatus instances are equal
        /// </summary>
        /// <param name="input">Instance of AnnOptimizationStatus to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AnnOptimizationStatus input)
        {
            if (input == null)
                return false;
