...
namespace BlackFoxCSharp.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class RnnOptimizationStatus :  IEquatable<RnnOptimizationStatus>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RnnOptimizationStatus" /> class.
        /// </summary>
        /// <param name="epoch">Number of epoch for current best model.</param>
        ...
        public RnnOptimizationStatus(int epoch = default(int), Guid guid = default(Guid), OptimizationState? state = default(OptimizationState?), int generation = default(int), int totalGenerations = default(int), double validationSetError = default(double), double trainingSetError = default(double), RnnModel bestModel = default(RnnModel), DateTime startDateTime = default(DateTime), DateTime estimatedDateTime = default(DateTime), long generationSeconds = default(long), string metricName = default(string))
        {
        ...
        public RnnOptimizationStatus() { }

        /// <summary>
        /// Number of epoch for current best model
        /// </summary>
        /// <value>Number of epoch for current best model</value>
        ...
        public RnnModel BestModel { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class RnnOptimizationStatus {\n");
        ...
        {
            return this.Equals(input as RnnOptimizationStatus);
        }

        /// <summary>
        /// Returns true if RnnOptimizationStatus instances are equal
        /// </summary>
        /// <param name="input">Instance of RnnOptimizationStatus to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RnnOptimizationStatus input)
        {
            if (input == null)
                return false;
