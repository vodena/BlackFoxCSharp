...
namespace BlackFoxCSharp.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AnnOptimizationEngineConfig :  IEquatable<AnnOptimizationEngineConfig>
    {
        /// <summary>
        ...
        public AnnOptimizationEngineConfig(OptimizationAlgorithm? optimizationAlgorithm = default(OptimizationAlgorithm?), int crossoverDistributionIndex = 20, double crossoverProbability = 0.9D, int mutationDistributionIndex = 20, double mutationProbability = default(double), int procTimeoutSeconds = 10800, int maxNumOfGenerations = 50, int populationSize = 50, ConvergencyCriterion hyperVolume = default(ConvergencyCriterion))
        {
            ...
            {
                throw new InvalidDataException("procTimeoutSeconds is a required property for AnnOptimizationEngineConfig and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("maxNumOfGenerations is a required property for AnnOptimizationEngineConfig and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AnnOptimizationEngineConfig {\n");
        ...
        {
            return this.Equals(input as AnnOptimizationEngineConfig);
        }

        /// <summary>
        /// Returns true if AnnOptimizationEngineConfig instances are equal
        /// </summary>
        /// <param name="input">Instance of AnnOptimizationEngineConfig to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AnnOptimizationEngineConfig input)
        {
            if (input == null)
                return false;
