...
namespace BlackFoxCSharp.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class RandomForestOptimizationStatus :  IEquatable<RandomForestOptimizationStatus>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RandomForestOptimizationStatus" /> class.
        /// </summary>
        ...
        public RandomForestModel BestModel { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class RandomForestOptimizationStatus {\n");
        ...
        {
            return this.Equals(input as RandomForestOptimizationStatus);
        }

        /// <summary>
        /// Returns true if RandomForestOptimizationStatus instances are equal
        /// </summary>
        /// <param name="input">Instance of RandomForestOptimizationStatus to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RandomForestOptimizationStatus input)
        {
            if (input == null)
                return false;
