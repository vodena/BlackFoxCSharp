...
namespace BlackFoxCSharp.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AnnSeriesTrainingConfig :  IEquatable<AnnSeriesTrainingConfig>
    {
        /// <summary>
        ...
        public AnnSeriesTrainingConfig(List<InputWindowConfig> inputWindowConfigs = default(List<InputWindowConfig>), List<OutputWindowConfig> outputWindowConfigs = default(List<OutputWindowConfig>), int outputSampleStep = default(int), int batchSize = 512, string datasetId = default(string), List<Range> inputRanges = default(List<Range>), AnnLayerConfig outputLayer = default(AnnLayerConfig), List<AnnHiddenLayerConfig> hiddenLayerConfigs = default(List<AnnHiddenLayerConfig>), NeuralNetworkTrainingAlgorithm trainingAlgorithm = default(NeuralNetworkTrainingAlgorithm), int maxEpoch = default(int), bool crossValidation = default(bool), double validationSplit = default(double), int? randomSeed = default(int?))
        {
            ...
            if (maxEpoch == null)
            {
                throw new InvalidDataException("maxEpoch is a required property for AnnSeriesTrainingConfig and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("validationSplit is a required property for AnnSeriesTrainingConfig and cannot be null");
            }
            else
            {
        ...
        /// </summary>
        [DataMember(Name="inputWindowConfigs", EmitDefaultValue=true)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AnnSeriesTrainingConfig {\n");
        ...
        {
            return this.Equals(input as AnnSeriesTrainingConfig);
        }

        /// <summary>
        /// Returns true if AnnSeriesTrainingConfig instances are equal
        /// </summary>
        /// <param name="input">Instance of AnnSeriesTrainingConfig to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AnnSeriesTrainingConfig input)
        {
            if (input == null)
                return false;
