...
namespace BlackFoxCSharp.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class RandomForestOptimizationConfig :  IEquatable<RandomForestOptimizationConfig>
    {
        /// <summary>
        ...
        {
            return this.Equals(input as RandomForestOptimizationConfig);
        }

        /// <summary>
        /// Returns true if RandomForestOptimizationConfig instances are equal
        /// </summary>
        /// <param name="input">Instance of RandomForestOptimizationConfig to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RandomForestOptimizationConfig input)
        {
            if (input == null)
                return false;
