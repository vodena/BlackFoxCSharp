...
namespace BlackFoxCSharp.Api
{
    ...
    /// </summary>
    public interface IXGBoostModelApi : IApiAccessor
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class XGBoostModelApi : IXGBoostModelApi
    {
        private BlackFoxCSharp.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="XGBoostModelApi"/> class.
        /// </summary>
        /// <returns></returns>
        public XGBoostModelApi(String basePath)
        {
        ...
        /// <returns></returns>
        public XGBoostModelApi(BlackFoxCSharp.Client.Configuration configuration = null)
        {
        ...
        public ApiResponse<System.IO.Stream> DownloadWithHttpInfo (string id)
        {
            ...
            if (id == null)
                throw new ApiException(400, "Missing required parameter 'id' when calling XGBoostModelApi->Download");

            var localVarPath = "./api/xgboost/model/{id}";
        ...
        public ApiResponse<Object> ExistsWithHttpInfo (string id)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ApiException(400, "Missing required parameter 'id' when calling XGBoostModelApi->Exists");
        ...
        public ApiResponse<Object> GetMetadataWithHttpInfo (string id)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ApiException(400, "Missing required parameter 'id' when calling XGBoostModelApi->GetMetadata");

            var localVarPath = "./api/xgboost/model/{id}/metadata";
            var localVarPathParams = new Dictionary<String, String>();
            var localVarQueryParams = new List<KeyValuePair<String, String>>();
            var localVarHeaderParams = new Dictionary<String, String>(this.Configuration.DefaultHeader);
            var localVarFormParams = new Dictionary<String, String>();
        ...
        public ApiResponse<string> UploadWithHttpInfo (System.IO.Stream file = default(System.IO.Stream))
        {
            ...
            var localVarPath = "./api/xgboost/model";
            var localVarPathParams = new Dictionary<String, String>();
            var localVarQueryParams = new List<KeyValuePair<String, String>>();
            var localVarHeaderParams = new Dictionary<String, String>(this.Configuration.DefaultHeader);
            var localVarFormParams = new Dictionary<String, String>();
