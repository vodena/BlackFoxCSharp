...
namespace BlackFoxCSharp.Api
{
    ...
    /// </summary>
    public interface ICustomMetricApi : IApiAccessor
    {
        ...
        /// <param name="id">Python file Id</param>
        ...
        /// <summary>
        /// Check if py file exist
        /// </summary>
        /// <remarks>
        /// 
        /// </remarks>
        /// <exception cref="BlackFoxCSharp.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="id">Python file Id (sha1)</param>
        /// <returns></returns>
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class CustomMetricApi : ICustomMetricApi
    {
        private BlackFoxCSharp.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="CustomMetricApi"/> class.
        /// </summary>
        /// <returns></returns>
        public CustomMetricApi(String basePath)
        {
        ...
        /// <returns></returns>
        public CustomMetricApi(BlackFoxCSharp.Client.Configuration configuration = null)
        {
        ...
        public ApiResponse<System.IO.Stream> DownloadWithHttpInfo (string id)
        {
            ...
            if (id == null)
                throw new ApiException(400, "Missing required parameter 'id' when calling CustomMetricApi->Download");

            var localVarPath = "./api/custommetric/{id}";
        ...
        public ApiResponse<Object> ExistsWithHttpInfo (string id)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ApiException(400, "Missing required parameter 'id' when calling CustomMetricApi->Exists");
        ...
        public ApiResponse<string> UploadWithHttpInfo (System.IO.Stream file = default(System.IO.Stream))
        {
            ...
            var localVarPath = "./api/custommetric";
            var localVarPathParams = new Dictionary<String, String>();
            var localVarQueryParams = new List<KeyValuePair<String, String>>();
            var localVarHeaderParams = new Dictionary<String, String>(this.Configuration.DefaultHeader);
            var localVarFormParams = new Dictionary<String, String>();
