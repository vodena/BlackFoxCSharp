...
namespace BlackFoxCSharp.Api
{
    ...
    /// </summary>
    public interface IRandomForestModelApi : IApiAccessor
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class RandomForestModelApi : IRandomForestModelApi
    {
        private BlackFoxCSharp.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="RandomForestModelApi"/> class.
        /// </summary>
        /// <returns></returns>
        public RandomForestModelApi(String basePath)
        {
        ...
        /// <returns></returns>
        public RandomForestModelApi(BlackFoxCSharp.Client.Configuration configuration = null)
        {
        ...
        public ApiResponse<System.IO.Stream> DownloadWithHttpInfo (string id, RandomForestModelType? modelType = default(RandomForestModelType?))
        {
            ...
            if (id == null)
                throw new ApiException(400, "Missing required parameter 'id' when calling RandomForestModelApi->Download");

            var localVarPath = "./api/random-forest/model/{id}";
        ...
        public ApiResponse<Object> ExistsWithHttpInfo (string id)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ApiException(400, "Missing required parameter 'id' when calling RandomForestModelApi->Exists");
        ...
        public ApiResponse<Object> GetMetadataWithHttpInfo (string id)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ApiException(400, "Missing required parameter 'id' when calling RandomForestModelApi->GetMetadata");

            var localVarPath = "./api/random-forest/model/{id}/metadata";
            var localVarPathParams = new Dictionary<String, String>();
            var localVarQueryParams = new List<KeyValuePair<String, String>>();
            var localVarHeaderParams = new Dictionary<String, String>(this.Configuration.DefaultHeader);
            var localVarFormParams = new Dictionary<String, String>();
        ...
        public ApiResponse<string> UploadWithHttpInfo (System.IO.Stream file = default(System.IO.Stream))
        {
            ...
            var localVarPath = "./api/random-forest/model";
            var localVarPathParams = new Dictionary<String, String>();
            var localVarQueryParams = new List<KeyValuePair<String, String>>();
            var localVarHeaderParams = new Dictionary<String, String>(this.Configuration.DefaultHeader);
            var localVarFormParams = new Dictionary<String, String>();
